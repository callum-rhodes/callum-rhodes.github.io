---
title: PiStation 1
summary: Raspberry Pi Playstation 1 emulation inside an original chassis.
tags:
  - Just for fun
  - Emulation
  - DIY
...
image:
  caption: Playstation 1 emulation
  focal_point: Smart

links:
url_code: 'https://github.com/callum-rhodes/PiStation1'
...
*Controller test*
![Controller test](./controller_wip.jpg)

*External view of finished system.*
![External view of the system](./case_open.jpg)

*Playing Metal Gear Solid for the first time.*
![HDMI up to a TV](./MGS.jpg)